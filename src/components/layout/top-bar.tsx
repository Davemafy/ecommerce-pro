import { Bell, BookOpen, CircleHelp, ExternalLink, Grid3X3, LifeBuoy, Package, ShoppingCart, Users } from 'lucide-react';
...
export function TopBar() {
  ...
  return <header className="topbar"><div className="topbar-spacer"/><div className="topbar-actions">
